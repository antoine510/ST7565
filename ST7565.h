...
class ST7565 {
 public:
  ...
  static void begin(uint8_t contrast);
  static void st7565_command(uint8_t c);
  static void st7565_data(uint8_t c);
  static void st7565_set_brightness(uint8_t val);
  ...
  static void fillcircle(uint8_t x0, uint8_t y0, uint8_t r, 
		  uint8_t color);
  static void drawcircle(uint8_t x0, uint8_t y0, uint8_t r, 
		  uint8_t color);
